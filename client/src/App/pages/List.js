            ...
            <Card.Body>
              <Row>
                ...
                <Col>
                  <Row>
                    <Col>
                      <h4 className="text-left cusH4">{detail.title}</h4>
                    </Col>
                    <Col>
                      <h4 className="text-right cusH4">
                        IMDB:
                        {detail.imdb && detail.imdb.rating
                          ? detail.imdb.rating
                          : "Nil"}
                      </h4>
                    </Col>
                  ...
                  <Row>
                    <div className="mt-4 mb-3 plotDiv">
                      <Card.Text>{detail.fullplot}</Card.Text>
                    </div>
                      ...
                      ? detail.comments.map((i) => (
                          <>
                            <li className="list-inline-item">
                              ...
                              <span className="commentDate ml-2 text-secondary">
                            ...
                            <li className="list-inline-item commentText text-secondary">
                              {i.text}
                            </li>
                          </>
                        ))
